...
The E2E test creates a `[E2E-TEST]` prefixed record, verifies it in NocoDB, then deletes it automatically. See [Netlify Functions Test Documentation](netlify/functions/__tests__/README.md) for details.
