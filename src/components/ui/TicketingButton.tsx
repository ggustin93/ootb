...
import TicketingModal, { type TicketingConfig } from './TicketingModal';
...
export default function TicketingButton({
  ...
  const variants = {
    primary:
      'bg-white border-2 border-[--ootb-orange] text-[--ootb-orange] hover:bg-[--ootb-orange] hover:text-white shadow-lg hover:shadow-xl',
