  ...
  'Mercredi 1/10': [
    {
      ...
      description:
        "Une conférence ludique et interactive pour découvrir le jeu de cartes original et inspirant d'Oriane Blondiaux. Vous apprendrez à stimuler l'imagination, l'intuition et la créativité de vos élèves à travers des exercices pratiques et des exemples concrets. Découvrez des techniques simples et efficaces pour intégrer des moments créatifs dans votre routine quotidienne de classe. Cette approche novatrice permet de développer la pensée divergente et la confiance en soi des élèves tout en maintenant leur engagement. Public : Maternelle-primaire et secondaire.",
