...
export const appelProjetCollection: Collection = {
  ...
  defaultItem: () => ({
    metadata: {
      ...
      description:
        'Partagez votre expérience pédagogique innovante et inspirez vos pairs lors du Festival Out of the Books 2024.',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          description:
            'Format: https://res.cloudinary.com/dza0sg4uf/video/upload/f_auto:video,q_auto/v1/OOTB/nom-video',
        },
      ],
    },
    {
