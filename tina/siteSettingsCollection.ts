...
export const siteSettingsCollection: Collection = {
  ...
  defaultItem: () => ({
    seo: {
      ...
      defaultDescription:
        "Out of the Books ASBL : l'éducation et le bien-être de l'enfant au cœur des priorités. Une plateforme collaborative pour transformer l'éducation en Belgique francophone.",
      language: 'fr',
  ...
  fields: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "Image utilisée pour les partages sociaux quand aucune image spécifique n'est fournie (1200x630px recommandé)",
          required: false,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          ui: {
            description:
              "Activez cette option et sauvegardez pour forcer un redéploiement complet du site. Utilisez en cas de problème d'affichage ou pour appliquer plusieurs modifications récentes.",
          },
        },
        {
          type: 'string',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "Liste des pages où l'annonce sera affichée. Utilisez 'all' pour toutes les pages. Exemples: home, about, contact, festival",
          list: true,
        },
        {
          type: 'string',
          ...
          description:
            "Liste des pages où l'annonce ne sera PAS affichée (prioritaire sur showOnPages). Exemples: festival, contact",
          list: true,
        },
      ],
    },
